...
{{- define "strimzi.kafka.image.map" }}
            ...
            - name: STRIMZI_KAFKA_MIRROR_MAKER_IMAGES
              value: |
                4.0.0={{ template "strimzi.image" (merge . (dict "key" "kafkaMirrorMaker" "tagSuffix" "-kafka-4.0.0")) }}
                4.0.1={{ template "strimzi.image" (merge . (dict "key" "kafkaMirrorMaker" "tagSuffix" "-kafka-4.0.1")) }}
                4.1.0={{ template "strimzi.image" (merge . (dict "key" "kafkaMirrorMaker" "tagSuffix" "-kafka-4.1.0")) }}
                4.1.1={{ template "strimzi.image" (merge . (dict "key" "kafkaMirrorMaker" "tagSuffix" "-kafka-4.1.1")) }}
